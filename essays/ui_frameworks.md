...
<img class="ui image" src="{{ site.baseurl }}/images/tori-richard.jpg">
  ...
  Semantic UI is so neat. The class names for the elements are basically the same as English language. For example, if I want to insert an menu to my web page, I can write ```HTML class="ui menu"```. If I don't want the border between the items, I can change the class name to ```HTML class="ui borderless menu"```.
